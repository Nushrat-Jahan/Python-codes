...
var = StringVar()
labels = []
label = Label( root, textvariable=var, relief=RAISED ).place(x=60,y=50)
var.set("INSTRUCTIONS:")
var = StringVar()
labels = []
label = Label( root, textvariable=var, relief=RAISED ).place(x=60,y=80)
var.set("Hey! Welcome to 2048 game!")
labels.append(label)
var = StringVar()
label = Label( root, textvariable=var, relief=RAISED ).place(x=60,y=110)
var.set("Please use 'w' for up key, 'a' for left key, 's' for right key and 'z' for down key")
labels.append(label)
var = StringVar()
label = Label( root, textvariable=var, relief=RAISED ).place(x=60,y=140)
var.set("Please use 'q' for extra random input and 'p' for auto playing")
labels.append(label)
var = StringVar()
label = Label( root, textvariable=var, relief=RAISED ).place(x=60,y=170)
var.set("Please use the X option to start the game")
labels.append(label)
